...
function postToken(req, res) {
  console.log('postToken() : Got token request');
...
function postE911Id(req, res) {
  console.log('postE911Id () : sending E911 request');
...
function polling(req, res) {
  ...
  //  if (req.body.token) {
  //
  //    //Waiting for the socket to get Created then poll
  //    app_local.createSocket(function (socket_io) {
  //      console.log('Danger', req.body);
  //      longPolling.longPolling(req.body, socket_io);
  //      res.json(200, {data: 'Long Polling triggred Successfully'});
  //    }, req.body.sessionId);
  //  }
  //  res.json(400, {message: 'please pass a valid access token as parameter'});
  //}
  //res.json(400, {message: 'please pass a sessionId as parameter'});
}

function webSocket(req, res) {
  //create a websocket tell the client to connect
  console.log('Websocket() ');
  app_local.createSocket(function () {
    res.json(200, {data: 'Long Polling triggered Successfully'});
  });
}
